...
function SignInFormContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // With Auth0, we don't need to handle signin manually
    // Users are authenticated automatically through Auth0
    setError('התחברות דרך Auth0 - לחץ על כפתור Auth0 למעלה');
    setIsLoading(false);
  };

  const handleDemoLogin = async () => {
    // With Auth0, demo login is not needed
    // Users can sign in directly through Auth0
    setError('התחברות דרך Auth0 - לחץ על כפתור Auth0 למעלה');
  };
