...
function generateInsights(
  ...
  if (category === 'all' || category === 'mood') {
    insights.push({
      ...
      description:
        'זוהה שיפור של 23% במצב הרוח הממוצע שלך ב-3 השבועות האחרונים. המגמה החיובית קשורה לעלייה בפעילות גופנית ותרגילי נשימה.',
      confidence: 87,
      priority: 'high',
      actionable: true,
      recommendations: [
    ...
    insights.push({
      ...
      description:
        'נצפתה מגמה של מצב רוח נמוך יותר בימי ראשון לעומת שאר ימות השבוע. זה עלול להיות קשור ל"דיכאון יום ראשון" הידוע.',
      confidence: 74,
      priority: 'medium',
      actionable: true,
      recommendations: [
  ...
  if (category === 'all' || category === 'goals') {
    insights.push({
      ...
      description:
        'השלמת 85% מהמטרות שהגדרת החודש, שיעור גבוה משמעותית מהממוצע הכללי של 60%. המטרות הקטנות והמדידות הראו הצלחה גבוהה יותר.',
      confidence: 92,
      priority: 'high',
      actionable: true,
      recommendations: [
  ...
  if (category === 'all' || category === 'habits') {
    insights.push({
      ...
      description:
        'כתבת ביומן 18 מתוך 21 הימים האחרונים - רצף מרשים! הכתיבה הקבועה תורמת לעיבוד רגשות ולבהירות מחשבתית.',
      confidence: 89,
      priority: 'medium',
      actionable: true,
      recommendations: [
    ...
    insights.push({
      ...
      description:
        'זוהו פערים של 3-4 ימים בתרגילי הנשימה. הימים ללא תרגול מתאמים לירידה קלה במצב הרוח.',
      confidence: 71,
      priority: 'medium',
      actionable: true,
      recommendations: [
  ...
  if (category === 'all' || category === 'health') {
    insights.push({
      ...
      description:
        'נמצא קשר חזק (r=0.73) בין איכות השינה למצב הרוח למחרת. לילות עם פחות מ-7 שעות שינה מתאמים למצב רוח נמוך יותר.',
      confidence: 84,
      priority: 'high',
      actionable: true,
      recommendations: [
  ...
  if (category === 'all' || category === 'social') {
    insights.push({
      ...
      description:
        'בימים עם פעילות חברתية (פגישות, שיחות טלפון, הודעות) מצב הרוח שלך גבוה ב-15% בממוצע. הקשרים החברתיים הם משאב חשוב עבורך.',
      confidence: 79,
      priority: 'medium',
      actionable: true,
      recommendations: [
  ...
  if (depth === 'advanced' || depth === 'deep') {
    insights.push({
      ...
      description:
        'זוהתה ירידה של 40% בפעילות הכללית ב-5 הימים האחרונים. זה כולל פחות תיעוד מצב רוח, פחות תרגילי נשימה ופחות כתיבה ביומן.',
      confidence: 91,
      priority: 'critical',
      actionable: true,
      recommendations: [
  ...
  return [
    {
      ...
      description:
        'מצב הרוח שלך נוטה להיות גבוה יותר באמצע השבוע (רביעי-חמישי) ונמוך יותר בסופי השבוע.',
      frequency: 'weekly',
      strength: 78,
      trend: 'stable',
      impact: 'neutral',
    ...
    },
    {
      ...
      description:
        'בימים עם תרגילי נשימה, מצב הרוח גבוה ב-1.3 נקודות בממוצע. האפקט נמשך גם למחרת.',
      frequency: 'daily',
      strength: 85,
      trend: 'improving',
      impact: 'positive',
    ...
    },
    {
      ...
      description:
        'ימים שמשיים מתאמים למצב רוח טוב יותר ב-0.8 נקודות. ימים גשומים מראים ירידה קלה.',
      frequency: 'daily',
      strength: 62,
      trend: 'stable',
      impact: 'neutral',
    ...
    },
    {
      ...
      description:
        'נוטה להשלים יותר מטרות בתחילת החודש ופחות לקראת הסוף. דפוס טיפוסי של מוטיבציה מחזורית.',
      frequency: 'monthly',
      strength: 71,
      trend: 'declining',
      impact: 'negative',
  ...
  return [
    {
      ...
      recommendation:
        'המשך עם התרגילים הנוכחיים והוסף מדיטציה קצרה לשיפור נוסף.',
    },
    {
      id: 'pred-2',
      ...
      data: {
        ...
        metadata: {
          ...
          criticalInsights: insights.filter((i) => i.priority === 'critical')
            .length,
          positiveInsights: insights.filter((i) => i.type === 'positive')
            .length,
          averageConfidence: Math.round(
            insights.reduce((sum, i) => sum + i.confidence, 0) / insights.length
          ),
          dataPointsAnalyzed: insights.reduce(
            (sum, i) => sum + i.dataPoints,
            0
          ),
