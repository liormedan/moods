  ...
  try {
    ...
    const user = await prisma.user.upsert({
      ...
      update: {
        ...
        name: 'ליאור מדן',
        image:
          'https://lh3.googleusercontent.com/a/ACg8ocJktworqVRGI55kON_V0uf2azkoVUXA5ep24QOOYxxAz_odvLVA=s96-c',
    ...
    const insights = [
      ...
      },
      {
        ...
        title: 'המלצה אישית',
        description:
          'מצב הרוח שלך נראה טוב! המשך לעקוב יומית לתובנות מעמיקות יותר.',
        priority: 'high',
        actionable: true,
      },
    ];
